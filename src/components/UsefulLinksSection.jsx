...
export function UsefulLinksSection() {
  return (
    <section className="panel border border-silver/30 bg-gradient-to-br from-gold/10 via-ucsb-navy/80 to-app-bg p-6">
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        {usefulLinkGroups.map((group) => (
          <div key={group.id} className="rounded-2xl border border-silver/30 bg-white/[0.04] p-5">
