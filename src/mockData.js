...
export const requirementSections = [
  {
    ...
    items: [
      ...
      { id: 'req-f', label: 'Area F: World Cultures', detail: 'Upper- or lower-division approved course', completed: true, transferEligible: false, courseCodes: ['GE F'] },
      {
        ...
        detail: 'Campus special graduation requirement — confirm overlap with Area F in GOLD',
        completed: false,
      ...
      },
      {
        ...
        detail: 'AHI requirement — often satisfied with lower-division U.S. history',
        completed: false,
        transferEligible: true,
        courseCodes: ['GE AHI'],
      },
      {
        ...
        detail: 'Ethnicity requirement — approved courses carry Ethnicity credit in GOLD',
        completed: false,
        transferEligible: true,
        courseCodes: ['GE ETH'],
      },
      {
        ...
        detail: 'European traditions requirement',
        completed: true,
      ...
      },
      {
        ...
        detail: 'Often met through major math and statistics — verify on your audit',
        completed: true,
        transferEligible: false,
