...
export const plannerSuggestions = [
  {
    ...
    units: 4,
    type: 'major',
    note: 'Common next step after ECON 10A and ECON 5; confirm sequencing with the catalog and L&S advising.',
  ...
  },
  {
    ...
    reasonTags: ['Upper-div core', 'Pairs with ECON 100B'],
  },
  {
    code: 'ECON 140A',
...
export const requirementSections = [
  ...
  {
    id: 'major',
    title: 'Economics B.A. — pre-major and upper division',
    description:
      'Pre-major: ECON 1, 2, 10A, ECON 5 (or PSTAT 120A), and calculus. Upper division includes 100B, 101, 140A, and electives.',
    items: [
      { id: 'req-econ1', label: 'ECON 1', detail: 'Principles of Microeconomics (pre-major)', completed: true, transferEligible: true, courseCodes: ['ECON 1'] },
      { id: 'req-econ2', label: 'ECON 2', detail: 'Principles of Macroeconomics (pre-major)', completed: true, transferEligible: true, courseCodes: ['ECON 2'] },
      { id: 'req-econ10a', label: 'ECON 10A', detail: 'Intermediate Microeconomic Theory (pre-major)', completed: true, transferEligible: false, courseCodes: ['ECON 10A'] },
      { id: 'req-econ5', label: 'ECON 5', detail: 'Data and Statistics — pre-major option (or PSTAT 120A)', completed: false, transferEligible: false, courseCodes: ['ECON 5'] },
      { id: 'req-econ101', label: 'ECON 101', detail: 'Statistics for Economists (upper division)', completed: false, transferEligible: false, courseCodes: ['ECON 101'] },
      { id: 'req-econ100b', label: 'ECON 100B', detail: 'Intermediate Macroeconomic Theory (upper division)', completed: false, transferEligible: false, courseCodes: ['ECON 100B'] },
      { id: 'req-econ140a', label: 'ECON 140A', detail: 'Intermediate Microeconomic Theory II (upper division)', completed: false, transferEligible: false, courseCodes: ['ECON 140A'] },
      ...
      { id: 'req-econud', label: 'Upper-division economics electives', detail: 'Department-approved upper-division economics coursework', completed: false, transferEligible: false, courseCodes: ['ECON 115', 'ECON 134A', 'ECON 134B', 'ECON 199RA', 'ECON 199'] },
    ],
  },
  {
    id: 'support',
    title: 'Mathematics and electives',
    description: 'Calculus for the major and open unit space toward 180 units.',
    items: [
      { id: 'req-math3a', label: 'MATH 3A', detail: 'Calculus I (pre-major)', completed: true, transferEligible: true, courseCodes: ['MATH 3A'] },
      { id: 'req-math3b', label: 'MATH 3B', detail: 'Calculus II (pre-major)', completed: true, transferEligible: false, courseCodes: ['MATH 3B'] },
...
export const chatbotSeedMessages = [
  ...
  },
  {
    id: 'bot-answer',
    sender: 'bot',
    text: 'Based on this sample L&S Economics roadmap, many students look at ECON 101 and ECON 100B after finishing ECON 10A and ECON 5, then balance the quarter with a remaining GE such as Area E (Culture and Thought). Your real schedule depends on prerequisites you have already satisfied—confirm every course in GOLD and with L&S or Economics advising.',
    bullets: [
...
export const econPrepFlowchart = {
  ...
  edges: [
    ...
    { from: 'econ10a', to: 'gateFull', fromSide: 'right', toSide: 'left', stroke: '#14b8a6' },
    { from: 'econ5', to: 'gateFull', fromSide: 'right', toSide: 'left', stroke: '#e879f9' },
    { from: 'econ101', to: 'gateFull', fromSide: 'right', toSide: 'left', stroke: '#fde047' },
    { from: 'math3b', to: 'gateFull', fromSide: 'right', toSide: 'left', stroke: '#a78bfa' },
    { from: 'gateFull', to: 'fullMajor', fromSide: 'right', toSide: 'left', stroke: '#facc15' },
  ],
  nodes: [
    {
      id: 'econ1',
    ...
    },
    {
      ...
      kind: 'course',
      label: 'ECON 101',
      subtitle: 'Statistics for economists',
      x: 420,
      y: 158,
      w: 218,
      h: 96,
    ...
    },
    {
      ...
      subtitle: '100B, 140A, electives',
      x: 860,
      y: 168,
      w: 300,
      h: 140,
      requires: ['econ2', 'math3b', 'econ10a', 'econ5', 'econ101'],
    },
  ],
}
