...
export const econPrepFlowchart = {
  ...
  height: 392,
  edges: [
    { from: 'econ1', to: 'econ2', fromSide: 'bottom', toSide: 'top' },
    { from: 'econ1', to: 'gate10a', fromSide: 'right', toSide: 'left' },
    { from: 'math3a', to: 'gate10a', fromSide: 'right', toSide: 'left' },
    { from: 'gate10a', to: 'econ10a', fromSide: 'right', toSide: 'left' },
    { from: 'math3a', to: 'math3b', fromSide: 'bottom', toSide: 'top' },
    { from: 'econ1', to: 'gatePstat', fromSide: 'right', toSide: 'left' },
    { from: 'math3a', to: 'gatePstat', fromSide: 'right', toSide: 'left' },
    { from: 'gatePstat', to: 'pstat109', fromSide: 'right', toSide: 'left' },
    { from: 'econ10a', to: 'econ10b', fromSide: 'bottom', toSide: 'top' },
    { from: 'econ2', to: 'gateFull', fromSide: 'right', toSide: 'left' },
    { from: 'math3b', to: 'gateFull', fromSide: 'right', toSide: 'left' },
    { from: 'econ10a', to: 'gateFull', fromSide: 'right', toSide: 'left' },
    { from: 'pstat109', to: 'gateFull', fromSide: 'right', toSide: 'left' },
    { from: 'econ10b', to: 'gateFull', fromSide: 'right', toSide: 'left' },
    { from: 'gateFull', to: 'fullMajor', fromSide: 'right', toSide: 'left' },
  ],
  nodes: [
    {
      id: 'econ1',
